...
import LuxuryVerifiedTestimonials from "../components/UI/LuxuryVerifiedTestimonials";
    ...
    <div className="font-body antialiased">
      ...
      <section id="testimonios" className="section-spacing bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-luxury-body text-lg max-w-3xl mx-auto">
      ...
      <section id="contacto" className="section-spacing bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-luxury-body text-lg mb-8 max-w-2xl mx-auto">
            Reserva tu consulta de diagnóstico 360° y descubre cómo el Método MAC puede transformar tu apariencia
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="luxury-card bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
              <h3 className="text-xl font-luxury-serif text-gold-deep mb-2">Consulta Inicial</h3>
              <p className="text-luxury-body text-sm">Evaluación completa y plan personalizado</p>
            </div>
            <div className="luxury-card bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
              <h3 className="text-xl font-luxury-serif text-gold-deep mb-2">Seguimiento 12 Meses</h3>
              <p className="text-luxury-body text-sm">Acompañamiento continuo garantizado</p>
            </div>
            <div className="luxury-card bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
              <h3 className="text-xl font-luxury-serif text-gold-deep mb-2">Resultados Garantizados</h3>
              <p className="text-luxury-body text-sm">Transformación visible en 90 días</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center luxury-btn rounded-full border border-[#008578] px-8 py-3 text-[#008578] font-luxury-cta transition-all duration-300 hover:bg-[#008578] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#008578] focus:ring-offset-2"
            >
